;
; comecho1 - DOS device driver/application sample: COM style (org 100h)
;
; to build (with nasm):
;   nasm -f bin -o comecho1.com comecho1.asm
...
Strategy:
		mov	word [cs: reqhdr - 100h], bx
		mov	word [cs: reqhdr + 2 - 100h], es
		retf

; fix CS:IP to COM-style (CS:xxxx -> CS-10h:xxxx+100h)
%MACRO		Org0CStoOrg100CS	0
		mov	ax, cs
